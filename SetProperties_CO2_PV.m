function [p, v, T, u, h, s, x] = SetProperties_CO2_PV(p, v)
    ...
    % Finding the final values of v_f and v_fg using linear interpolation
...
%         end
        ...
        T1 = interp1( data2(temp_rowL:temp_rowL+9,3), data2(temp_rowL:temp_rowL+9,2), v);
        T2 = interp1( data2(temp_rowU:temp_rowU+9,3), data2(temp_rowU:temp_rowU+9,2), v);
         
        u1 = interp1( data2(temp_rowL:temp_rowL+9,3), data2(temp_rowL:temp_rowL+9,4), v);
        u2 = interp1( data2(temp_rowU:temp_rowU+9,3), data2(temp_rowU:temp_rowU+9,4), v);
        
        h1 = interp1( data2(temp_rowL:temp_rowL+9,3), data2(temp_rowL:temp_rowL+9,5), v);
        h2 = interp1( data2(temp_rowU:temp_rowU+9,3), data2(temp_rowU:temp_rowU+9,5), v);
        
        s1 = interp1( data2(temp_rowL:temp_rowL+9,3), data2(temp_rowL:temp_rowL+9,6), v);
        s2 = interp1( data2(temp_rowU:temp_rowU+9,3), data2(temp_rowU:temp_rowU+9,6), v);
        
        % Calculating the final values of the required properties
        T  = T1  + (T2  -  T1)*(p - pL)/(pU - pL);
        u  = u1  + (u2  -  u1)*(p - pL)/(pU - pL);
        h  = h1  + (h2  -  h1)*(p - pL)/(pU - pL);
        s  = s1  + (s2  -  s1)*(p - pL)/(pU - pL);
